...
public class FacileNiveau4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_facile_niveau_4);
    ...
    public void Verif(int idBoutonClicke) throws InterruptedException {
        ...
        if(tabStock[compteur] == idBoutonClicke)
        {
            if(compteur+1 == nbBlocSequence){
                ...
                if(nbBlocSequence == maxBlocEclaires)
                {
                    ...
                    affichage_score.setText("Score: " +score);
                    Thread.sleep(3000);
                    Intent niveauSuivant = new Intent(FacileNiveau4.this, FacileNiveau5.class);
        ...
        else
        {
            ...
            if(vie == 0){
                ...
                Thread.sleep(2000);
                Intent recommencer = new Intent(FacileNiveau4.this, RecommencerNiveau.class);
