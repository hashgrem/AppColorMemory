...
public class ExpertNiveau3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_expert_niveau_3);
    ...
    public void Verif(int idBoutonClicke) throws InterruptedException {
        ...
        else
        {
            ...
            if(vie == 0){
                ...
                Thread.sleep(2000);
                Intent recommencer = new Intent(ExpertNiveau3.this, RecommencerNiveau.class);
