...
public class FacileNiveau2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_facile_niveau_2);
    ...
    public void Verif(int idBoutonClicke) throws InterruptedException {
        ...
        if(tabStock[compteur] == idBoutonClicke)
        {
            if(compteur+1 == nbBlocSequence){
                ...
                if(nbBlocSequence == maxBlocEclaires)
                {
                    ...
                    affichage_score.setText("Score: " +score);
                    Thread.sleep(3000);
                    Intent niveauSuivant = new Intent(FacileNiveau2.this, FacileNiveau3.class);
        ...
        else
        {
            ...
            if(vie == 0){
                ...
                Thread.sleep(2000);
                Intent recommencer = new Intent(FacileNiveau2.this, RecommencerNiveau.class);
